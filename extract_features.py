...
from libretrieval.features.extraction import *
from objret.features.keypoints import *

from libretrieval.io import read_array_file
from libretrieval.io import write_array_file
from libretrieval.io import write_array_bin_file
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save", "-s",
                        help="Indicates the files to save. 'single' saves one feature vector "
